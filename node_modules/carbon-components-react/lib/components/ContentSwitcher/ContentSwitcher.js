  ...
  _createClass(ContentSwitcher, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["children", "className", "light", "selectedIndex", "selectionMode", "size"]);

      var classes = (0, _classnames.default)("".concat(prefix, "--content-switcher"), className, (_classNames = {}, _defineProperty(_classNames, "".concat(prefix, "--content-switcher--light"), light), _defineProperty(_classNames, "".concat(prefix, "--content-switcher--").concat(size), size), _classNames));

  ...
  _createClass(Tab, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          renderButton = _this$props.renderAnchor,
      ...
      var buttonProps = (_buttonProps = {}, _defineProperty(_buttonProps, 'aria-selected', selected), _defineProperty(_buttonProps, 'aria-disabled', disabled), _defineProperty(_buttonProps, 'aria-controls', "".concat(id, "__panel")), _defineProperty(_buttonProps, "id", id), _defineProperty(_buttonProps, "className", "".concat(prefix, "--tabs--scrollable__nav-link")), _defineProperty(_buttonProps, "href", href), _defineProperty(_buttonProps, "tabIndex", !disabled ? tabIndex : -1), _defineProperty(_buttonProps, "ref", function ref(e) {
        _this.tabAnchor = e;
      }), _buttonProps);
      return /*#__PURE__*/_react.default.createElement("li", _extends({}, other, {
        ...
        role: "presentation"
      }), renderButton ? renderButton(buttonProps) : /*#__PURE__*/_react.default.createElement("button", _extends({
        type: "button",
        role: "tab"
      }, buttonProps), label));
    }
...
_defineProperty(Tab, "propTypes", {
   ...
   */
  tabIndex: (0, _deprecate.default)(_propTypes.default.number)
});
